            ...
            >
              ...
              <div class="flex">
                <input
                  type="text"
                  v-model="image1"
                  class="block w-1/2 mr-2 px-4 py-3 mb-4 border border-2 border-transparent border-gray-200 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none"
                  placeholder="image 1"
                />
              ...
              <div class="my-3">
                <div
                  ...
                  class="items-center px-3 py-2 mr-2 leading-none rounded text-xs font-medium uppercase inline-block tag mt-3"
                >
                  <span>{{ tag }}</span>
                </div>
              </div>
  ...
  methods: {
    ...
    async submit() {
      ...
      try {
        ...
        await Swal.fire(
          "Congratulations!",
          "You just made an attempt to save a live. We will review your application and send you a message!",
          "success"
        );
      } catch (error) {
        await this.startCampaign(
